export var mat4 = {
    ...
    inverse: function (m: any, dst: any) {
    ...
    xRotate: function (m: any, angleInRadians: any) {
        return mat4.multiply(mat4.xRotation(angleInRadians), m);
    },

    yRotate: function (m: any, angleInRadians: any) {
        return mat4.multiply(mat4.yRotation(angleInRadians), m);
    },

    zRotate: function (m: any, angleInRadians: any) {
        return mat4.multiply(mat4.zRotation(angleInRadians), m);
    },
    ...
    unitVector: function (v: any) {
        let vModulus = mat4.vectorModulus(v);
        return v.map(function (x: any) { return x / vModulus; });
    },

    vectorModulus: function (v: any) {
        return Math.sqrt(Math.pow(v[0], 2) + Math.pow(v[1], 2) + Math.pow(v[2], 2));
    },

    crossProduct: function (v1: any, v2: any) {
        let result = [
            v1[1] * v2[2] - v1[2] * v2[1],
            v1[2] * v2[0] - v1[0] * v2[2],
            v1[0] * v2[1] - v1[1] * v2[0]
    ...
    setViewingMatrix: function (P0: any, Pref: any, V: any) {
        let N = [
            P0[0] - Pref[0],
            P0[1] - Pref[1],
            P0[2] - Pref[2]
        ];
        let n = mat4.unitVector(N);
        let u = mat4.unitVector(mat4.crossProduct(V, n));
        let v = mat4.crossProduct(n, u);

        let translationMatrix = mat4.translation(-P0[0], -P0[1], -P0[2]);
        let rotationMatrix = [
            u[0], v[0], n[0], 0,
            u[1], v[1], n[1], 0,
            u[2], v[2], n[2], 0,
    ...
    setOrthographicProjectionMatrix: function (xw_min: any, xw_max: any, yw_min: any, yw_max: any, z_near: any, z_far: any) {
        return [
    ...
    setPerspectiveProjectionMatrix: function (xw_min: any, xw_max: any, yw_min: any, yw_max: any, z_near: any, z_far: any) {
        return [
